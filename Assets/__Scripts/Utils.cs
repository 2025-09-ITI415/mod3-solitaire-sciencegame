...
public class Utils : MonoBehaviour
{
    ...
    public static void SetCameraBounds(Camera cam = null)
    {
        ...
        // Assumes the camera is Orthographic and at rotation [0,0,0]
    ...
    public static Vector3 BoundsInBoundsCheck(Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen)
    {
        ...
        switch (test)
        {
            ...
            // to keep all of lilB inside bigB
            ...
            // The offScreen test determines what off would need to be applied
            // to move any tiny part of lilB inside of bigB
